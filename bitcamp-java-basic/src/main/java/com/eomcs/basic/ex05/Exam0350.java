...
// => 다음과 같이 한 개의 점이 있다.
//    10001100 10010010 10101100 (변경전 색)
//  & 11011011 11011101 11111111     /빨강과 초록색 약화 
// -------------------------------
//    10001000 10010000 10101100 (변경한 색)
//비트 연산 활용 예3:
//=> 흑백을 반전 시키
//=> 방법: 빛이있는 점을 빛을없에고 빛이 없는 점에 빛을 넣는다
//=> 다음과 같이 한 개의 점이 있다.
// 00000000 00000000 00000000 (검은색)
//~
//-------------------------------
// 11111111 11111111 11111111 (변경한 흰색)

//
//비트 연산 활용 예4:
//=> 필터 만들기 
//=> 방법:^연산자를 사용하여  특정 색상만 제거하
// 특정 비트만 통과시키는 필터 만들기 
//=> 다음과 같이 한 비트 데이터 가 있다.
// 11001010 11100100 00111001 (변경전 색) //제거하려는ㄴ 색
//^11001010 11100100 00111001     /같은 색을데이터로쓰면됨
//-------------------------------
// 00000000 00000000 00000000 (변경한 색 필) //출력 결
//한점에 대해 연산한 출력결과가 0이면 해정점의 색상을 제거하고 만약 0이 아니면 원래색상을 그대로사용한다
...
// =3 byte /pixel
//= 1677_7216색상 한픽셀을 색상으로 나타 낼 수 있는
//2073600 pixel * 3 byte =622_8900 byte = 6082kb =5.94mb
//1000_0000 * 3 = 3000_0000 = 29_296kb = 28.6 mb (raw data file)
//
//80분 영화 
//80 * 60(초) * 24(장) = 115,200(장)
//용량 115,200 * 6mb = 691200mb
//675gb ==> 4gb (압축) MPEG
//
